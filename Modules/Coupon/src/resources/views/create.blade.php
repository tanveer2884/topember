        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                    <form action="{{ route(config('coupon.routeNamePrefix').'coupons.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-control-inline custom-switch">
                                    <input type="checkbox" value="1" name="discount_is_percent" {{ old('discount_is_percent') ? 'checked':'' }} class="custom-control-input" id="is_percent">
                        ...
                        <div class="controls row mb-1 align-items-center">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" id="coupon-value" name="value"  value="{{ old('value') }}" placeholder="Value" />
                                @error('value')
                                <div class="help-block text-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-control-inline custom-switch">
                                    <input type="checkbox" name="is_free_shipping" {{ old('is_free_shipping') ?'checked':'' }} class="custom-control-input" id="is_free_shipping">
                        ...
                        <div class="controls row mb-1 align-items-center">
                            ...
                            <div class="col-md-8 position-relative">
                                <input type="date" name="start_at" value="{{ old('start_at') }}" class="form-control" id="start_at">
                        ...
                        <div class="controls row mb-1 align-items-center">
                            ...
                            <div class="col-md-8 position-relative">
                                <input type="date" name="end_at" value="{{ old('end_at') }}" class="form-control" id="end_at">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-control-inline custom-switch">
                                    <input type="checkbox" name="is_active" {{ old('is_active') ? 'checked' :'' }} class="custom-control-input" id="is_active">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-control-inline custom-switch">
                                    <input type="checkbox" name="is_site_wide" {{ old('is_site_wide') ? 'checked' :'' }} class="custom-control-input" id="is_site_wide">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8">
                                <select name="excludeProducts[]" class="form-control selectpicker" multiple>
                                    <option value="">Select Products</option>
                                    @foreach($allProducts as $product)
                                    <option value="{{ $product->id }}" {{ in_array($product->id,old('excludeProducts',[])) ? 'selected':'' }}>{{ $product->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8">
                                <select name="excludeCategories[]" class="form-control selectpicker" multiple>
                                    <option value="">Select Products</option>
                                    @foreach($allCategories as $category)
                                    <option value="{{ $category->id }}" {{ in_array($category->id,old('excludeCategories',[])) ? 'selected':'' }}>{{ $category->name }}</option>
                                    @endforeach
                                </select>
