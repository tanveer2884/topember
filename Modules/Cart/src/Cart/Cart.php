...
class Cart
{
    ...
    /**
     * the session key use to persist cart Extra Data Like Shipping/billing info etc
     *
     * @var
     */
    protected $sessionKeyExtraData;
    ...
    public function __construct($session, $events, $instanceName, $session_key, $config)
    {
        ...
        $this->sessionKeyExtraData = $this->sessionKey . '_cart_extra_data';
        $this->config = $config;
