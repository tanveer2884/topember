                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active py-2" id="product-details" role="tabpanel" aria-labelledby="product-detail-tab">
                                <form action="{{ route(config('product.routeNamePrefix').'products.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="model_number" value="{{ old('model_number') }}" required class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="sku" value="{{ old('sku') }}" required class="form-control">
                                            @error('sku')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="qty" value="{{ old('qty') }}" required class="form-control">
                                            @error('qty')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" name="weight" value="{{ old('weight') }}" required class="form-control">
                                            @error('weight')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="custom-control custom-control-inline custom-switch">
                                                <input type="checkbox" value="1" name="is_inStock" {{ old('is_inStock') ?'checked':'' }} class="custom-control-input" id="is_inStock">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="custom-control custom-control-inline custom-switch">
                                                <input type="checkbox" value="1" name="is_active" {{ old('is_active') ?'checked':'' }} class="custom-control-input" id="is_active">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="custom-control custom-control-inline custom-switch">
                                                <input type="checkbox" value="1" name="is_featured" {{ old('is_featured') ?'checked':'' }} class="custom-control-input" id="featured">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" step="0.01" name="special_price" value="{{ old('special_price') }}" class="form-control">
                                            @error('special_price')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6 position-relative">
                                            <input type="date" id="special_price_start_date" name="special_start_at" value="{{ old('special_start_at') }}" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6 position-relative">
                                            <input type="date" id="special_end_at" name="special_end_at" value="{{ old('special_end_at') }}" class="form-control">
