...
use Topdot\Product\Contracts\UpdateProductRequest as ContractsUpdateProductRequest;

class UpdateProductRequest extends FormRequest implements ContractsUpdateProductRequest
{
    /**
