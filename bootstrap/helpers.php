...
if (! function_exists('get_max_fileupload_size')) {
    ...
    function get_general_site_settings($key = null, $type = 'type')
    {
        $settings = collect([
            ...
            'copyright_text' => ['value' => '<p>©:CURRENT_YEAR <span>Demo Company</span>', 'type' => 'text', 'rules' => 'string|max:255'],
            ...
            'socail' => ['value' => '', 'type' => 'hidden', 'rules' => ''],
            ...
            'social_urls' => ['value' => "Social Url's", 'type' => 'heading', 'rules' => ''],
            ...
            'socail_end' => ['value' => '', 'type' => 'hidden', 'rules' => ''],

            'smtp_settings' => ['value' => 'SMTP Setting', 'type' => 'heading', 'rules' => ''],
