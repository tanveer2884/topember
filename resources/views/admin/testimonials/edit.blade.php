                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.testimonials.update',$testimonial) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="title" value="{{ old('title',$testimonial->title) }}" placeholder="title" />
                                    @error('title')
                            ...
                            {{-- <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="number" min="1" max="5" class="form-control" name="rating" value="{{ old('rating',$testimonial->rating) }}" placeholder="rating" />
                                    @error('rating')
                                    <div class="help-block text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-8">
                                    <textarea type="text" class="form-control" name="description" placeholder="description" >{{ old('description',$testimonial->description) }}</textarea>
                                    @error('description')
                                    <div class="help-block text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
