            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.faqs.index') }}" class="btn btn-primary">Back to
                            List</a>
                    </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.faqs.update', $faq) }}" method="post"
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="answer" class="editor form-control" >{{ old('answer',$faq->answer) }}</textarea>
                                        @error('answer')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="sort_order"
                                            value="{{ old('sort_order', $faq->sort_order) }}" placeholder="sort_order" />
                                        @error('sort_order')
                                            <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                {{-- <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="status" >
                                            <option value="1" {{ old('status',$faq->is_active) == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ old('status',$faq->is_active) == 0 ? 'selected' : '' }}>Disabled</option>
                                        </select>
                                        @error('status')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
