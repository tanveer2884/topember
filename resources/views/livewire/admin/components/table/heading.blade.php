<th
    {{ $attributes->merge(['class' => 'whitespace-nowrap px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:bg-gray-800 dark:text-gray-400'])->only('class') }}
>
    @unless ($sortable)
